<div id="tariffs" class="tariffs">
    ...
    <div class="tariff_items col-md-12 col-sm-12 col-12">
        ...
        <div class="b5_con3 tariff_card col-md-12 col-sm-12 col-12" id="b5con3">
            <div class="b5_con3t b5_content tariff_content" id="b5con3t">
                <div class="b5_content3_header tariff_header">{!! __('home.pro') !!}<span class="tariff_mark"> только 10
                                    человек</span></div>
                <span class="b5_1 b5_0 ">{!! __('home.1_ay_tedris') !!}</span>
                <span class="b5_2 b5_0">{!! __('home.45_video_ders') !!}</span>
    ...
    <div class="t_head">
        <h3 class="tariff_text red_highlight">{!! __('home.hele_de_subhelenirsiz') !!}</h4>
            <h5 class="tariff_text">{!! __('home.sinaq_paketi_yoxlayin') !!}</h6>
    </div>
    <div class="b5_con4 tariff_card col-md-12 col-sm-12 col-12 mx-auto" id="b5con4">
        <div class="b5_con3t b5_content tariff_content" id="b5con3t">
            <div class="b5_content3_header tariff_header"><span class="b5_content3_header1"> {!! __('home.trial') !!}</span>
            </div>
